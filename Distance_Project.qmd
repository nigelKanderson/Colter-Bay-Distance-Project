...
# The SonoBat classifier calls some Mylu as Labo (Eastern red bat) and some Myev
# as Myse (N. long-eared) -- neither occurs in the Grand Teton fauna
# (see R/38_species_checklist.R). Fold them back before filtering.
data_env <- data_env %>%
  mutate(species = recode(species, Labo = "Mylu", Myse = "Myev"))
