...
- **Panel 6 — Moth families:** detections by intensity; by distance; by moon phase.
...
![Panel 2 — Bat detections: (A) by colour × intensity, (B) by intensity × distance.](output/figures/panels/panel2_bat_color_intensity_dist.png)
...
![Panel 5 — Moth detections: (A) by colour × intensity, (B) by intensity × distance.](output/figures/panels/panel5_moth_color_intensity_dist.png)

![Panel 6 — Moth family detections: (A) by intensity, (B) by distance, (C) by moon phase.](output/figures/panels/panel6_moth_family.png)

![Panel 7 — Bat vs. moth % change: (A) colour, (B) intensity, (C) distance.](output/figures/panels/panel7_bat_vs_moth_pct.png)
