...
# Acoustic guilds by call frequency. These partition the 9 focal species and
# are reused by the guild-cluster models below. A label joins a guild only if
# EVERY candidate species in it belongs to that guild. The medium-frequency
# guild is a single species (Myev), so it is labelled "Myev".
